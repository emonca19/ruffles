...
export default function DetalleComprobante() {
  ...
  const [statusLocal, setStatusLocal] = useState(
    mapStatusToUI(evidencia?.status)
  );
  ...
  if (!evidencia) {
    return (
      ...
      <div
        className="error-screen p-10 text-center bg-red-50 border border-red-300 rounded-lg m-10"
      ...
      >
        ...
        <p className="text-red-600 mb-4">
          Esto sucede cuando la tarjeta no pasa los datos correctamente.
        </p>
        <button
  ...
  return (
    <div className="ruffle-detail-container">
      ...
      <div className="detail-header">
        ...
        <div className="detail-info">
          ...
          <p className="detail-description">
            **Cliente:** {evidencia.customer_name}
            <br />
            **Rifa:** {evidencia.raffle_name}
            <br />
      ...
      >
        ...
        >
          <p
            className={`p-2 font-bold rounded-lg border ${getStatusColor(
              statusLocal
            )}`}
